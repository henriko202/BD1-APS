...
public class Funcionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Logradouro", "Bairro", "Cidade", "Estado", "Pais", "Telefone", "Salario"
            }
        ) {
    ...
    private void loadRecords() throws SQLException {
        String sql = "SELECT id, nome, logradouro, bairro, cidade, estado, pais, telefone, salario FROM Funcionario ORDER BY id;";
        ...
        jTable1.getSelectionModel().addListSelectionListener((ListSelectionEvent event) -> {
            try {
                if (jTable1.getSelectedRow() >= 0) {
                    ...
                    Object salario = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 8);
    ...
    private void updateRecord() throws SQLException, ParseException {
        FuncionarioDAO dao = new FuncionarioDAO();
        model.Funcionario fun = new model.Funcionario();
        fun.setId(Integer.parseInt(txtId.getText()));
        fun.setNome(txtNome.getText());
        fun.setLogradouro(txtLogra.getText());
        fun.setBairro(txtBairro.getText());
        fun.setCidade(txtCidade.getText());
